...
<TABLE	WIDTH="100%"
	...
	<TR>
		...
		<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="90%">
			<TR>
				<TD><IMG src="<?php echo $GLOBALS['_PJ_image_path'] ?>/abstand.gif" HEIGHT="20" WIDTH="1" BORDER="0"></TD>
			</TR><TR>
				<TD><IMG src="<?php echo $GLOBALS['_PJ_image_path'] ?>/abstand.gif" HEIGHT="20" WIDTH="1" BORDER="0"></TD>
			</TR><TR>
				<TD><b><?php if(!empty($GLOBALS['_PJ_strings']['not_implemented'])) echo $GLOBALS['_PJ_strings']['not_implemented'] ?>!</b></TD>
			</TR><TR>
				<TD><IMG src="<?php echo $GLOBALS['_PJ_image_path'] ?>/abstand.gif" HEIGHT="20" WIDTH="1" BORDER="0">
				<HR SIZE="1"></TD>
			</TR><TR>
				<TD><?php if(!empty($GLOBALS['_PJ_strings']['translations'])) echo $GLOBALS['_PJ_strings']['translations'] ?></TD>
			</TR><TR>
				<TD><IMG src="<?php echo $GLOBALS['_PJ_image_path'] ?>/abstand.gif" HEIGHT="40" WIDTH="1" BORDER="0"></TD>
			</TR><TR>
