			...
			<TR>
				<TD VALIGN="top"><TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
					<TR HEIGHT="24">
						...
						<TD CLASS="option" BACKGROUND="<?php if(!empty($GLOBALS['_PJ_image_path'])) echo $GLOBALS['_PJ_image_path'] ?>/option-sb.gif">&nbsp;&nbsp;<A CLASS="option" HREF="<?= $_PJ_http_root ?>/inventory/contracts.php?customer_id=<?= $customer->giveValue('id') ?>">Contracts</A></TD>
						<TD>&nbsp;</TD>
					</TR>
				</TABLE></TD>
			</TR>
