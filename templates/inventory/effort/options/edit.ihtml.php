			...
			<TR>
				<TD VALIGN="top"><TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
					<TR HEIGHT="24">
						...
						<TD CLASS="option" BACKGROUND="<?php echo $GLOBALS['_PJ_image_path'] ?>/option-sb.gif">&nbsp;&nbsp;<A CLASS="option" HREF="<?= $GLOBALS['_PJ_effort_script'] . "?edit=1&cid=".@$cid.'&pid='.@$pid.'&eid='.@$eid."" ?> "><?= $GLOBALS['_PJ_strings']['effort_basic_data']?></A></TD>
