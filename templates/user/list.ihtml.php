...
<?php
	...
	include($GLOBALS['_PJ_root'] . '/templates/user/options/list.ihtml.php');
...
<?php
	...
	while($users->nextUser()) {
		...
		include("$_PJ_root/templates/user/row.ihtml.php");
...
?>
					...
					<TR>
						...
						<TD COLSPAN="5"><IMG SRC="<?php echo $GLOBALS['_PJ_image_path'] ?>/gray.gif" WIDTH="100%" HEIGHT="1" BORDER="0"></TD>
